...
<style type="text/css">
   ...
   <b>"ShortCodes" will be replaced by "ShortCodes Value" while rendering table at frontend. Use image url or any text for shortcode value.</b>
...
<input class="button" type="button" name="addnew" id="addnew" value="ADD NEW">
    ...
    <div style="float: right;width:400px;">
        <a href="http://wpeden.com/minimax-wordpress-page-layout-builder-plugin/" style="width:97%;overflow:hidden;margin:5px;background: #fafafa;border: 1px solid #ccc;display: block;float: left;text-align: center;-webkit-border-radius: 6px;-moz-border-radius: 6px;border-radius: 6px;" ><h3 style="margin: 0px;background: #ccc;-webkit-border-top-left-radius: 5px;-webkit-border-top-right-radius: 5px;-moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px;border-top-left-radius: 5px;border-top-right-radius: 5px;padding:5px;text-decoration: none;color:#333">Drag and Drop Content Builder</h3><img src="<?php echo plugins_url('pricing-table/images/minimax.png'); ?>" /></a>
