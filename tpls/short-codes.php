...
<table id="wp-shortcode-table" class="wp-list-table widefat fixed posts" cellpadding="4" width="100%" cellspacing="15">
    ...
    if(is_array($shortcode)){
        ...
        <tr id="<?php echo "row_".$i;?>">
            ...
            <td><img class='deleterow' rel='<?php echo "row_".$i;?>' title='Delete this row' src='<?php echo plugins_url();?>/pricing-table/images/delete.png' /></td>
        </tr>
         <?php   
        }
    }
...
<input class="button" type="button" name="addnew" id="addnew" value="ADD NEW">
    ...
    <div style="float: right;width:400px;">
        <a href="http://wpeden.com/minimax-wordpress-page-layout-builder-plugin/" class="promo" target="_blank"><h3>Drag and Drop Content Builder</h3><img src="<?php echo plugins_url('pricing-table/images/minimax.png'); ?>" /></a>
